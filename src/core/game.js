...
export class Game {
  ...
  async _onKeyDown(e) {
    ...
    if (code === "Digit0" || code === "Numpad0") { const v = this.renderer.toggleCoveField(); this._showHud("Cove field: " + (v ? "BAKED (texture — watch corner baseboards)" : "LIVE (analytic scan)")); return; }
  }
