...
export class Game {
  ...
  async _onKeyDown(e) {
    ...
    if (code === "Digit6" || code === "Numpad6") { const v = this.renderer.cyclePBRDebug(); const names=["OFF","Moss bright green","Puddle bright blue/pink","Moss R + Puddle B"]; this._showHud("PBR Debug: " + (names[v]||"Mode "+v) + " (" + v + ") - swapped shaders, no if in main"); return; }
